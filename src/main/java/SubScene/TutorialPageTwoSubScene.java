...
public class TutorialPageTwoSubScene {
    ...
    private static GridPane tutorialMainSection(){
        ...
        pane.add(text("Here's another image that might help!", 18), 0,0);
        pane.add(text("It's a smart idea to have the rest of your \n fingers following the keys in the home row", 18),0, 1);
        pane.add(new ImageView("tutorial/base_position.jpg"),0,2);
    ...
    private static Button createNextButton(){
        ...
        nextButton.setOnMouseClicked(mouseEvent -> {
            showSubScene(TutorialPageThreeSubScene.createTutorialSubScene());
        });
        return nextButton;
    }
